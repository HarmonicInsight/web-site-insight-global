const features = [
  {
    ...
    title: "47 languages, 6 AI engines (INST)",
  ...
  },
  {
    ...
    title: "Four operations on one file (INST)",
  ...
  },
  {
    ...
    title: "Layout comes through untouched (INST)",
  ...
  },
  {
    ...
    title: "Screen recording → tutorial (INMV)",
    desc: "Capture on-screen actions, AI converts to documented tutorial slides with auto-narration. Perfect for SaaS onboarding flows, software manuals, and IT training docs.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Podcast-ready audio export (INMV)",
    desc: "Same workflow, audio-only output. Generate WAV or MP3 podcast episodes from PPTX or scripts. Ready for Spotify, Apple Podcasts, or your internal corp comms feed.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Local processing — your files stay on your PC",
    desc: "No cloud upload, no data harvesting, no third-party retention. Contracts, HR docs, IP, and source decks never leave your device. IT review boards approve in days, not weeks.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Glossary + translation memory (INST)",
  ...
  },
  {
    ...
    title: "Two-wipe overlay — presenter or sign-language (INMV)",
    desc: "Two simultaneous picture-in-picture tracks. Drop in a presenter video, branded watermark, or sign-language interpreter — at once. Accessibility-ready when you need it.",
  },
];
