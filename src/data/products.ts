...
export const products: Product[] = [
  ...
  },
  {
    ...
    tagline: "Slides, narration, sign-language overlay — one studio, no editor.",
    iconBg: "from-violet-400 via-purple-500 to-indigo-600",
    emoji: "🎬",
    description:
      "Producing one training video the traditional way: voice actor + studio + editor + two weeks + $1,800–3,000. The Insight Training Studio way: drop a PowerPoint, pick a narration language, layer in optional presenter or sign-language wipes, export MP4 in five minutes.",
    features: [
      ...
      { title: "Audio-first workflow", desc: "Export the narration as WAV first, then build matching slides or wipe footage to fit. Pro-grade flexibility." },
      { title: "Two-wipe overlay (sign-language ready)", desc: "Two simultaneous picture-in-picture tracks. Drop in a sign-language interpreter, a presenter, or both — at once." },
      { title: "Three TTS engines, freely switchable", desc: "Cloud (Edge Neural) + offline (VOICEVOX, Windows OneCore). ElevenLabs supported via BYOK." },
      ...
      { title: "Local processing", desc: "Your slides, narration, and overlays stay on your PC. No cloud upload." },
    ],
    bestFor: [
      "Corporate training teams with PowerPoint backlogs",
      "Accessibility / D&I leads producing inclusive course material with sign-language overlays",
      "Public-sector and education orgs with EAA / ADA / 障害者差別解消法 obligations",
